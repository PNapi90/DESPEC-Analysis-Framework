...
#pragma link C++ class TSCNAnalysis+;
#pragma link C++ class TSCNUnpackEvent+;
#pragma link C++ class TSCNUnpackProc+;
#pragma link C++ class TSCNCalEvent+;
#pragma link C++ class TSCNCalProc+;
