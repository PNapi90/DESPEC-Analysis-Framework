...
// Input event is by default an MBS event
  factory->DefEventProcessor("x7_Proc","First_Test");// object name, class name
  factory->DefOutputEvent("x7_Event","TGo4EventElement"); // object name, class name
...
if(servermode)
{
   ...
   analysis->SetAdministratorPassword("x7_admin");
   analysis->SetControllerPassword("x7_ctrl");
   analysis->SetObserverPassword("x7_view");
