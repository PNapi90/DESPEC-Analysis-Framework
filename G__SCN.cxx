...
"/u/pnapiral/DESPEC_Beta/DESPEC-Analysis-Framework/",
0
    };
...
class __attribute__((annotate("$clingAutoload$TSCNParameter.h")))  __attribute__((annotate("$clingAutoload$./FINGER_Detector_System.h")))  TSCNParameter;
