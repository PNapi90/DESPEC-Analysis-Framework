...
class __attribute__((annotate("$clingAutoload$TSCNUnpackEvent.h")))  __attribute__((annotate("$clingAutoload$./TSCNCalEvent.h")))  TSCNUnpackEvent;
class __attribute__((annotate("$clingAutoload$./TSCNCalEvent.h")))  TSCNCalEvent;
